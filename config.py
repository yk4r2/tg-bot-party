...
К сожалению, места закончились. Но Оля будет ждать тебя на своем тематическом открытом классе в MDC 18 октября в 19:00 по адресу М. Новокузнецкая; Пятницкая ул., д.6/1, стр.8. Ещё Оля дарит тебе скидку 20% на следующий Мастер-Класс!''',
    'event_start': '''Did you miss me, {username}? Главный хакер на проводе.
Оля захвачена.
Чтобы помочь Оле, вы должны выучить хореографию и выиграть хакеров в танцевальном баттле. У вас есть время до 21:30.''',
    'preparation_reminder': '''Привет, {username}!
Время тренировки почти на исходе! Готовься к битве!''',
    'victory_announcement': '''Вы хорошо сражались, {username}.
Главный хакер сказал, что защитники сегодня сильнее, а Оля спасена.
Теперь всем надо снять видео с танцем.''',
    'bad_bunny_reveal': '''{username}, вы ничего не забыли?
Самое время сорвать маску с главного хакера!''',
    'jam_session': '''Эй, {username}, время для джема!
Формируйте круг, скоро из колонок зазвучит музыка.''',
